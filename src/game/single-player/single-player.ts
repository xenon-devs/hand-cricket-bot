      ...
      if (!hasVoted) {
        try {
          ...
          if (answer.answer.trim().toLowerCase() === 'yes') {
            send(this.stadium, `<@${this.challenger.id}> Click on the link below. Sign in with your discord account, vote for our bot and come back in 5 min. \n https://top.gg/bot/709733907053936712/vote`);
