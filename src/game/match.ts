...
export class Match {
  ...
  getScoreBoard() {
    ...
    .addField(`Chaser`, `<@${ this.opener === Players.CHALLENGER ? this.opponent.id : this.challenger.id }>`, false)
    ...
    scoreboard.addField(`Balls played in 1st innings`, this.ballsPlayed[0], false);

    if (this.numInnings > 1) scoreboard.addField(`Chaser's score`, this.chaserScore, true);
    if (this.numInnings > 1) scoreboard.addField('Balls played in second innings', this.ballsPlayed[1], false);
